...
const localCache = {
    ...
    "save": async function (fileLink, fn, fileType) {
        try {
            ...
            if (oneData !== undefined && oneData !== null) {
                // await inDB.write(fileType + fn + '_data', oneData);
...
//             "pt": "/hfrags/",
//             "vr": "1",
//             "st": "ls" // ls = localStorage (if you want quicker loading of this resource)
//         },
//         {
//             "fn": "main.html.min.js",
//             "pt": "/hfrags/",
//             "vr": "1",
//             "st": "indb" // indb = indexeddb (if this resources is larger and should be stored in indexeddb, will load slightly later)
//         },
//         {
//             "fn": "footer.html.min.js",
//             "pt": "/hfrags/",
//             "vr": "1",
//             "st": "indb"
//         }
